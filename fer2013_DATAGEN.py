...
def load_data(sample_split=0.3, usage='Training', to_cat=True, verbose=True,
              classes=['Angry','Happy'], filepath='/home/arunvaish9/PycharmProjects/TensorFlow/fer2013/fer2013.csv'):
...
def save_data(X_train, y_train, fname='', folder='/home/arunvaish9/PycharmProjects/TensorFlow/fer2013/'):
